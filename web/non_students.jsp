        ...
        <div class="page">
            ...
            <div class="page-content d-flex align-items-stretch"> 
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        <li class="active"> <a href="non_students.jsp"> <i class="fa fa-user-circle-o"></i>Student Profile </a></li>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="form-horizontal" id="form">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Studying grade</label>
                                                    <div class="col-sm-9">
                                                        <input id="classLevel" type="text"  placeholder="Grade 2" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">       
...
//                                                                data.text
                                                         ...
                                                         $(function() { $("#dob").datepicker({  maxDate: '0'}); });
        </script>
    </body>
</html>
