    ...
    <body onload="load()">
            ...
            <div class="page-content d-flex align-items-stretch"> 
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="active"><a href="student_grade.jsp"> <i class="fa fa-cubes"></i>Grade </a></li>
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" id="form">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="userId" type="hidden" value="${studentId}" class="form-control form-control-success">
                                                        <input id="gradeId" type="hidden" value="0" class="form-control form-control-success">
                                                        <input id="studentFeedback" type="text" placeholder="Feedback" class="form-control form-control-success">
                                                    </div>
                                                </div>
                                                <div class="form-group row">       
                                                    <div class="col-sm-9 offset-sm-3">
                                                        <input type="button" onclick="update()" value="Add Feedback" class="btn btn-primary">
        ...
        <script>
                                                            ...
                                                            function selectedRowToInput() {
                                                                ...
                                                                for (var i = 0; i < table.rows.length; i++) {
                                                                    table.rows[i].onclick = function () {
                                                                        ...
                                                                        document.getElementById("studentFeedback").value = this.cells[7].textContent;
                                                                    }
                                                                    ;
                                                                }
                                                            }
                                                            ...
                                                            function update() {
                                                                ...
                                                                var studentFeedback = $('#studentFeedback').val();
                                                                var action = "feedback_update";
                                                                if (studentFeedback === "") {
                                                                    ...
                                                                    $.ajax({
                                                                        url: 'GradeServlet',
                                                                        method: 'POST',
                                                                        data: {userId: userId, action: action, gradeId: gradeId, studentFeedback: studentFeedback},
