            ...
            <div class="page-content d-flex align-items-stretch"> 
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        <li class="active"><a href="non_payment.jsp"> <i class="fa fa-money"></i>Payment </a></li>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li> <a href="non_teacher.jsp"> <i class="fa fa-user-circle-o"></i>Teacher Profile </a></li>
                    </ul>
                </nav>
                <div class="content-inner">
                    ...
                    <section class="forms"> 
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card" id="payment_report">
                                            ...
                                            <form class="form-horizontal" id="form">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <select class="form-control-success" id="studentId">
                                                            <option value="-1">Student ID / Name</option>
                                                            <%
                                                                try{
                                                                    
                                                                    String Query="SELECT * FROM school_management_system_2020.student";
                                                                    Class.forName("com.mysql.jdbc.Driver").newInstance();
                                                                    Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/school_management_system_2020", "root", "1234");
                                                                    Statement stm=conn.createStatement();
                                                                    ResultSet rs = stm.executeQuery(Query);
                                                                    while(rs.next()){
                                                                        
                                                                        %>
                                                                        <option value="<%=rs.getInt("student_id")%>"><%=rs.getInt("student_id")%>&nbsp;&nbsp; <br> <br> /<br><%=rs.getString("name")%><br>&nbsp;&nbsp; <br>&nbsp;&nbsp; <br> &nbsp;&nbsp;&nbsp;&nbsp;</option>
                                                                        <%
                                                                    }
                                                                }
                                                                catch(Exception ex){
...
//only number validation
                                                            ...
                                                            function Export() {
                                                                html2canvas(document.getElementById('payment_report'), {
