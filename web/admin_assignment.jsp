                            ...
                            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                ...
                                <li class="nav-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><span class="d-none d-sm-inline-block"><i class="fa fa-user-circle"></i>  Profile</span></a>
                                    <ul aria-labelledby="languages" class="dropdown-menu">
                                        ...
                                        <li><a rel="nofollow" href="#" class="dropdown-item">${userid}</a></li>
            ...
            <div class="page-content d-flex align-items-stretch"> 
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        <li class="active"><a href="admin_assignment.jsp"> <i class="icon-list"></i>Assignments </a></li>
                ...
                <div class="content-inner">
                    ...
                    <section class="forms"> 
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card" id="submitted_assignments">
                                        
                                        <div class="card-header d-flex align-items-center">
                                            <h3 class="h4">Submitted Assignments from Students</h3>
                                        </div>
                                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center">
                                            <h3 class="h4">New Assignments</h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">                       
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" id="form">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="classLevel" type="number"  class="form-control form-control-success">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Subject</label>
                                                    <div class="col-sm-9">
                                                        <input id="assignmentId" type="hidden" value="0" class="form-control form-control-success">
                                                            ...
                                                            function selectedRowToInput() {
                                                                ...
                                                                for (var i = 0; i < table.rows.length; i++) {
                                                                    table.rows[i].onclick = function () {
                                                                        ...
                                                                        document.getElementById("assignmentId").value = this.cells[1].textContent;
                                                                        document.getElementById("classLevel").value = this.cells[2].textContent;
                                                                        document.getElementById("subject").value = this.cells[3].textContent;
                                                                        document.getElementById("topic").value = this.cells[4].textContent;
                                                                        document.getElementById("no").value = this.cells[5].textContent;
//                                                                        document.getElementById("file").value = this.cells[5].textContent;
                                                                        document.getElementById("note").value = this.cells[7].textContent;
                                                                    }
                                                                    ;
                                                                }
                                                            }
                                                            ...
                                                            function save() {
                                                                ...
                                                                if (subject === "" || topic === "" || no === "" || note === "" ) {
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        method: 'POST',
                                                                        data: {userId: userId, action: action, assignmentId: assignmentId,classLevel:classLevel, subject: subject, topic: topic, no: no, file:file, note: note},
                                                                            ...
                                                                            .then((willDelete) => {
                                                                                if (willDelete) {
                                                                                    $.ajax({
                                                                                        url: 'AssignmentServlet',
                                                                                        method: 'POST',
                                                                                        data: {userId: userId, action: action, assignmentId: assignmentId},
                                                                                        success: function (resultText) {
...
//only number validation
                                                            ...
                                                            function Export() {
                                                                alert("called");
                                                                html2canvas(document.getElementById('submitted_assignments'), {
