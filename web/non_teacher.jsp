                            ...
                            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                ...
                                <li class="nav-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><span class="d-none d-sm-inline-block"><i class="fa fa-user-circle"></i>  Profile</span></a>
                                    <ul aria-labelledby="languages" class="dropdown-menu">
                                        ...
                                        <li><a rel="nofollow" href="#" class="dropdown-item">ID : ${teacherId}</a></li>
            ...
            <div class="page-content d-flex align-items-stretch"> 
                ...
                <nav class="side-navbar">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="non_payment.jsp"> <i class="fa fa-money"></i>Payments </a></li>
                    </ul><span class="heading">${userfullname} - Profile</span>
                    <ul class="list-unstyled">
                        <li> <a href="non_students.jsp"> <i class="fa fa-user-circle-o"></i>Student Profile </a></li>
                        <li class="active"> <a href="non_teacher.jsp"> <i class="fa fa-user-circle-o"></i>Teacher Profile </a></li>
                    </ul>
                </nav>
                <div class="content-inner">
                    ...
                    <section class="forms"> 
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card" id="teacher_report">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" id="form">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Teacher ID</label>
                                                    <div class="col-sm-9">
                                                        <input id="teacherId" type="text" value="0" class="form-control form-control-success" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">Lecture Name</label>
                                                    <div class="col-sm-9">
                                                        <input id="name" type="text" onkeypress="validateName()" placeholder="Lecturers Name" class="form-control form-control-success">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">In charge class</label>
                                                    <div class="col-sm-9">
                                                        <input id="classLevel" type="text"  placeholder="Grade 1" class="form-control form-control-warning">
                                                    </div>
                                                </div>
        ...
        <script>
                                                            ...
                                                            function selectedRowToInput() {
                                                                ...
                                                                for (var i = 0; i < table.rows.length; i++) {
                                                                    table.rows[i].onclick = function () {
                                                                        ...
                                                                        document.getElementById("teacherId").value = this.cells[1].textContent;
                                                            ...
                                                            function save() {
                                                                ...
                                                                if (name === "" || address === "" || email === "" || dob === "") {
                                                                    ...
                                                                    swal("Invalid!", "Invalid Email", "error");
                                                                } else {
                                                                    $.ajax({
                                                                        url: 'TeacherServlet',
                                                                        method: 'POST',
                                                                        data: {userId: userId, action: action, teacherId: teacherId, name: name, address: address, email: email, dob: dob, classLevel: classLevel},
                                                                            ...
                                                                            .then((willDelete) => {
                                                                                if (willDelete) {
                                                                                    $.ajax({
                                                                                        url: 'TeacherServlet',
                                                                                        method: 'POST',
                                                                                        data: {userId: userId, action: action, teacherId: teacherId},
                                                                                        success: function (resultText) {
...
//only number validation
                                                            ...
                                                            function Export() {
                                                                html2canvas(document.getElementById('teacher_report'), {
